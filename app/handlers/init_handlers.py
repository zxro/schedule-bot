...
from app.handlers.schedule.professor_schedule import router as professor_schedule_router
from app.handlers.schedule.bells_schedule import router as bells_schedule_router
